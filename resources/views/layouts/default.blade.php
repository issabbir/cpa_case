...
<head>
	...
	<title>CPA {{env('MODULE_TITLE')}} @yield('title', 'CPA'.env('MODULE_TITLE'))</title>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('assets/css/incident-common.css')}}">
...
<!-- BEGIN: Application global common -->
<script src="{{asset('assets/js/scripts/incident-common.js')}}"></script>
<!-- BEGIN: Application global common -->
